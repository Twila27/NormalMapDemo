#include "Engine/Time/Time.hpp" // #Eiserloh: Fixed #include path error
...
double GetCurrentTimeSeconds()
{
	...
	static double secondsPerCount = InitializeTime( initialTime ); //Only ever called once thanks to static.
