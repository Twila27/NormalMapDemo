...
void XboxController::MapControlSticks( short sThumbLX, short sThumbLY, short sThumbRX, short sThumbRY )
{
	...
	float leftStickRadius = sqrt( static_cast<float>( ( sThumbLX * sThumbLX ) + ( sThumbLY * sThumbLY ) ) );
	float rightStickRadius = sqrt( static_cast<float> ( ( sThumbRX * sThumbRX ) + ( sThumbRY * sThumbRY ) ) );
	...
	m_correctedRightStick.x = correctedRightStickRadius * cos( rightStickThetaRadians );
	m_correctedRightStick.y = correctedRightStickRadius * sin( rightStickThetaRadians );
	...
	m_correctedLeftStickInPolar.thetaRadians = leftStickThetaRadians + ( leftStickThetaRadians < 0.f ? 2 * PI : 0.f );
	m_correctedRightStickInPolar.thetaRadians = rightStickThetaRadians + ( rightStickThetaRadians < 0.f ? 2 * PI : 0.f );
}
