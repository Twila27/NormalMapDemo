...
class XboxController
{
	...
	public:
		...
		void Update();
		Vector2 GetLeftStickPosition() const { return m_correctedLeftStick; }
		...
		Vector2 GetRightStickPosition() const { return m_correctedRightStick; }
		...
		bool WasRigtShoulderButtonJustPressed( ) const { return m_rightShoulderButton.m_didButtonJustChange; }
